...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addWishlist(Product $product): static
    {
        if (!$this->wishlists->contains($product)) {
            $this->wishlists->add($product);
        }
        return $this;
    }

    public function removeWishlist(Product $product): static
    {
        $this->wishlists->removeElement($product);
        return $this;
    }
